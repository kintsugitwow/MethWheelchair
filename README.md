...
During Chess fight displays dark yellow full-screen effect during King's Fury cast that changes to light pink once player breaks line of sight with the King, provided that both SuperWoW and UnitXP Service Pack 3 are correctly installed. In case of lack of UnitXP, effect will remain dark yellow. *(Additional full-screen effects option in settings)*<br>
...
Use ``/mw chesstest`` to conduct test of King casting King's Fury. Your target will temporarily become the King.<br>
